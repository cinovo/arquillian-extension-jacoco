/*
 * JBoss, Home of Professional Open Source Copyright 2009, Red Hat Middleware LLC, and individual contributors by the @authors tag. See the
...
public class ArquillianRuntime implements IRuntime {
	...
	public static synchronized ArquillianRuntime getInstance() {
		if (ArquillianRuntime.runtime == null) {
			ArquillianRuntime.runtime = new ArquillianRuntime();
		}
		return ArquillianRuntime.runtime;
	}
    ...
    */
	...
	/**
	 * Retrieves the execution probe array for a given class. The passed {@link Object} array instance is used for parameters and the return
	 * value as follows. Call parameters:
	 * 
	 * <ul>
	...
	public void swapExecutionData(Object[] args) {
		...
		if (this.runtimeData == null) {
			args[0] = new boolean[probecount];
		} else {
			synchronized (this.runtimeData) {
				args[0] = this.runtimeData.getExecutionData(classid, name, probecount).getProbes();
			}
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.jacoco.core.runtime.IExecutionDataAccessorGenerator#generateDataAccessor(long, java.lang.String, int,
	...
	public int generateDataAccessor(long classid, String classname, int probecount, MethodVisitor mv) {
		...
		mv.visitMethodInsn(Opcodes.INVOKESTATIC, "org/jboss/arquillian/extension/jacoco/container/ArquillianRuntime", "getInstance", "()Lorg/jboss/arquillian/extension/jacoco/container/ArquillianRuntime;");
		...
		mv.visitMethodInsn(Opcodes.INVOKEVIRTUAL, "org/jboss/arquillian/extension/jacoco/container/ArquillianRuntime", "swapExecutionData", "([Ljava/lang/Object;)V");
	...
	/**
	 * Generates code that creates the argument array for the <code>getExecutionData()</code> method. The array instance is left on the
	 ...
	 */
	public static void generateArgumentArray(final long classid, final String classname, final int probecount, final MethodVisitor mv) {
