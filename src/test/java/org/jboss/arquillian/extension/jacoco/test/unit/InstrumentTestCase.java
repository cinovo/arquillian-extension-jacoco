...
public class InstrumentTestCase {
	...
	public void trace() throws Exception {
		ClassReader reader = new ClassReader(this.getTargetClass(CoverageBean.class.getName()));
	...
	public void shouldGetCoverageData() throws Exception {
		...
		final byte[] instrumented = instr.instrument(this.getTargetClass(targetName), "arquillian");
		...
		analyzer.analyzeClass(this.getTargetClass(targetName), "arquillian");
